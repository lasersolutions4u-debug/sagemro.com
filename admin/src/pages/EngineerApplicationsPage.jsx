...
const TEXT = {
  en: {
    ...
    accountHint: 'If cooperation is approved, complete the engineer account setup, then mark this application as Account created.',
    previous: 'Previous',
    next: 'Next',
  },
  'zh-CN': {
    ...
    saved: '申请审核已更新。',
    failed: '更新失败：',
    accountHint: '如确认合作，请先完成工程师账号开通，再把该申请标记为“已创建账号”。',
    previous: '上一页',
    next: '下一页',
  },
};
