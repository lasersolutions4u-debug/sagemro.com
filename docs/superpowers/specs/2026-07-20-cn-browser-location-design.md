...
Remove the Chinese site's paid geocoder dependency while preserving customer site confirmation, engineer arrival check-in, coordinate storage, and geofence verification.
