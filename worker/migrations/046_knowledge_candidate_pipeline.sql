-- 046: Structured service-report evidence and the reviewed knowledge-candidate pipeline.
...
INSERT OR IGNORE INTO _migrations (version, note) VALUES
    ('046_knowledge_candidate_pipeline', 'Structured repair evidence and reviewed knowledge-candidate lifecycle');
