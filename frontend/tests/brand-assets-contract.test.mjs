...
test('engineer recruiting page leads with engineer leverage and a bounded service workflow', () => {
  ...
  assert.match(recruiting, /title: 'Make Your Expertise Count'/);
  assert.match(recruiting, /Spend less time chasing incomplete details and making avoidable visits/);
  ...
  assert.doesNotMatch(recruiting, /title: '设备维保最佳方案：AI知识飞轮\+工程师技能实践。'|title: 'Make Your Expertise Count\.'/);
  ...
  assert.match(recruiting, /Be Known for What You Can Solve/);
  assert.match(recruiting, /Better Jobs\. Less Hassle\./);
  assert.match(recruiting, /Build a Reputation That Compounds/);
