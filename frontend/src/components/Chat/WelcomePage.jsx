...
const copy = {
  en: {
    eyebrow: 'SAGEMRO AI Equipment Service',
    headline: 'Start with AI-assisted equipment troubleshooting.',
    intro: 'Describe the alarm, material, machine model, production impact, or service question. SAGEMRO AI helps structure the issue before requesting service, parts, or further assessment.',
    cardTitle: 'Let AI organize the first service brief.',
    cardText: 'Write what you see on site. AI turns scattered symptoms into a clear service brief, asks for missing details, flags safety concerns, and prepares next-step options for you to review.',
    trustPoints: [
      'AI will ask for missing details before the case moves forward',
  ...
  zh: {
    eyebrow: 'SAGEMRO AI 设备服务平台',
    headline: '从 AI 设备问题分析开始。',
    intro: '请说明报警、材料、设备型号、生产影响或具体问题。SAGEMRO AI 会先整理问题，再辅助你判断是否需要维修、备件或进一步检查。',
    cardTitle: '让 AI 先整理第一份服务简报。',
    cardText: '按现场实际情况填写即可。AI 会把零散现象整理成清晰的服务摘要，追问缺失信息，提示安全风险，并生成可确认的下一步建议。',
    trustPoints: [
