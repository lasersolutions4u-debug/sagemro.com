...
const copy = {
  en: {
    ...
    cardTitle: 'Start with the field facts, not a sales form.',
    ...
    trustPoints: [
      'Not a sales shortcut: AI analysis should stay useful even when you do not request service',
