...
const copy = {
  en: {
    ...
    headline: 'Keep laser and sheet-metal equipment running with AI-assisted service intake.',
    intro: 'SAGEMRO supports international customers with independent after-sales service, spare parts, consumables, laser peripherals, retrofit needs, automation accessories, and press brake tooling. Describe what is happening on site, and SAGEMRO helps organize the details that matter for diagnosis, parts confirmation, maintenance planning, service coordination, or upgrade review.',
    ...
    trustPoints: [
      'Independent third-party support for alarms, downtime, spare parts, consumables, and maintenance',
      'Laser peripheral and post-processing needs: chillers, dust collectors, gas mixers, deburring, air systems, and nitrogen systems',
      'Retrofit and automation support for lifting, seventh-axis, gantry, and press brake tooling projects',
    ],
    capabilities: [
      'Fault diagnosis',
      'Cutting parameters',
  ...
  zh: {
    ...
    intro: 'SAGEMRO 是面向激光切割机与钣金加工设备的第三方智能服务品牌。你只需要说清现场情况，系统会帮助整理关键信息，把问题推进到故障判断、备件确认、维保安排、服务协调或增购改造评估。',
    ...
    trustPoints: [
      '第三方设备服务：报警、停机、备件、维保和增购改造需求，都可以从一次对话开始',
