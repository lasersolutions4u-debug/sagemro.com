...
const LEAD_COPY = {
  en: {
    ...
    close: 'Close',
    intro: 'Leave your contact info and SAGEMRO will review your service, parts, consumables, peripheral equipment, or retrofit request. Include machine brand/model, part number, country, urgency, and photos available when you can.',
    name: 'Name *',
    ...
    messagePlaceholder: 'Country / region, equipment model, part number, urgency, and preferred contact channel...',
    submit: 'Submit',
  ...
  cn: {
    ...
    close: '关闭',
    intro: '留下联系方式后，SAGEMRO 会结合你的 AI 咨询、服务需求、备件需求或增购改造需求，确认更合适的下一步。',
    name: '姓名 *',
