...
const LEAD_COPY = {
  en: {
    ...
    close: 'Close',
    intro: 'Leave your contact info and SAGEMRO will review your AI intake, service need, spare parts or consumables request, peripheral equipment need, or retrofit project, then guide the next step.',
    name: 'Name *',
