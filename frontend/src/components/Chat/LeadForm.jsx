      ...
      >
        ...
        {done ? (
          <div className="p-8 text-center">
            ...
            <p className="text-[var(--color-text-primary)] font-medium mb-1">Submitted successfully!</p>
            <p className="text-sm text-[var(--color-text-secondary)]">Our team will contact you shortly.</p>
            <button
              onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-3">
            ...
            <div>
              <label className="block text-xs text-[var(--color-text-secondary)] mb-1">Phone</label>
              <input
                type="tel"
                value={form.phone}
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Briefly describe your equipment needs..."
                rows={2}
