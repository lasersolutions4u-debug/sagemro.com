  ...
  return (
    <section className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-elevated)] p-4 sm:p-5">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <SelectField label={copy.material} value={currentValue.material} onChange={(material) => updateGlobal('material', material)} options={Object.entries(catalog.materials).map(([itemValue, item]) => ({ value: itemValue, label: item.label }))} />
