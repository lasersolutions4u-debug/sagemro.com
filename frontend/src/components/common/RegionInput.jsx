...
const administrativeDivisions = {
  ...
  '山西省': {
    ...
    '晋中市': ['榆次区', '太谷区', '昔阳县', '祁县', '左权县', '寿阳县', '太谷县', '平遥县', '灵石县', '介休市'],
  ...
  '黑龙江省': {
    ...
    '伊春市': ['伊美区', '乌翠区', '友好区', '嘉荫县', '汤旺县', '丰林县', '南岔县', '大箐山县', '铁力市'],
    '佳木斯市': ['向阳区', '前进区', '东风区', '郊区', '桦南县', '桦川县', '汤原县', '抚远市', '富锦市'],
    '七台河市': ['新兴区', '桃山区', '茄子河区', '勃利县'],
    '牡丹江市': ['东安区', '阳明区', '爱民区', '西安区', '林口县', '绥芬河市', '海林市', '宁安市', '穆棱市', '东宁市'],
    '黑河市': ['爱辉区', '逊克县', '孙吴县', '北安市', '五大连池市', '嫩江市'],
    '绥化市': ['北林区', '望奎县', '兰西县', '青冈县', '庆安县', '绥棱县', '安达市', '肇东市', '海伦市'],
    '大兴安岭地区': ['漠河市', '呼玛县', '塔河县']
  },
  '上海市': {
  ...
  '福建省': {
    ...
    '三明市': ['梅列区', '三元区', '沙县', '明溪县', '清流县', '宁化县', '大田县', '尤溪县', '将乐县', '泰宁县', '建宁县', '永安市'],
  ...
  '山东省': {
    ...
    '烟台市': ['芝罘区', '福山区', '牟平区', '莱山区', '蓬莱区', '黄渤海新区', '长岛综合试验区', '龙口市', '莱阳市', '莱州市', '招远市', '栖霞市', '海阳市'],
    ...
    '德州市': ['德城区', '陵城区', '临邑县', '平原县', '夏津县', '武城县', '庆云县', '临邑县', '齐河县', '禹城市', '乐陵市'],
  ...
  '河南省': {
    ...
    '周口市': ['川汇区', '淮阳区', '扶沟县', '西华县', '商水县', '沈丘县', '鄲城县', '鹿邑县', '项城市'],
  ...
  '湖北省': {
    ...
    '宜昌市': ['西陵区', '伍家岗区', '点军区', '猇亭区', '夷陵区', '远安县', '兴山县', '稀归县', '长阳土家族自治县', '五峰土家族自治县', '宜都市', '当阳市', '枝江市'],
  ...
  '湖南省': {
    ...
    '岳阳市': ['岳阳楼区', '云溪区', '君山区', '岳阳县', '华容县', '湘阴县', '平江县', '泪罗市', '临湘市'],
    ...
    '永州市': ['零陵区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县', '回龙圩管理区'],
  ...
  '广东省': {
    ...
    '深圳市': ['罗湖区', '福田区', '南山区', '宝安区', '龙岗区', '盐田区', '龙华区', '坪山区', '光明区', '大鹏新区', '深汕特别合作区'],
    '珠海市': ['香洲区', '斗门区', '金湾区'],
  ...
  '广西壮族自治区': {
    ...
    '柳州市': ['城中区', '鱼峰区', '柳南区', '柳北区', '柳江区', '柳城县', '鹿寨县', '融安县', '融水苗族自治县', '三江侗族自治县', '柳州市区'],
    ...
    '百色市': ['右江区', '田阳区', '田东县', '平果县', '德保县', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林各族自治县', '靖西市', '平果市'],
  ...
  '海南省': {
    ...
    '文昌市': ['文城镇', '重兴镇', '蓬莱镇', '会文镇', '东路镇', '文教镇', '东郊镇', '龙楼镇', '昌洒镇', '翁田镇', '抱罗镇', '冯坡镇', '锦山镇', '铺前镇', '抱虎镇'],
    '万宁市': ['万城镇', '龙滚镇', '和乐镇', '后安镇', '大茂镇', '东澳镇', '礼纪镇', '长丰镇', '山根镇', '北大镇', '南桥镇', '三更罗镇'],
    '东方市': ['八所镇', '东河镇', '大田镇', '感城镇', '板桥镇', '三家镇', '四更镇', '新龙镇', '天安乡', '江边乡']
  },
  '重庆市': {
    '重庆市': ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '渝北区', '巴南区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县']
  },
  '四川省': {
    ...
    '资阳市': ['雁江区', '安岳县', '乐至县'],
    '阿坝藏族羌族自治州': ['马尔康市', '汶川县', '理县', '茂县', '松潘县', '九寨沟县', '若尔盖县', '红原县', '壤塘县', '阿坝县', '久治县', '班玛县'],
    '甘孜藏族自治州': ['康定市', '泸定县', '丹巴县', '九龙县', '雅江县', '道孚县', '理塘县', '巴塘县', '乡城县', '稻城县', '得荣县', '甘孜县', '新龙县', '德格县', '白玉县', '石渠县', '色达县', '炉霍县'],
    '凉山彝族自治州': ['西昌市', '会理县', '德昌县', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县', '木里藏族自治县']
  },
  '贵州省': {
    ...
    '毕节市': ['七星关区', '大方县', '黔西县', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县', '百里杜鹃管理区'],
  ...
  '青海省': {
    ...
    '海西蒙古族藏族自治州': ['德令哈市', '格尔木市', '茫崖市', '乌兰县', '都兰县', '天峻县', '大柴旦行政区']
  },
  '宁夏回族自治区': {
  ...
  '台湾省': {
    ...
    '新北市': ['板桥区', '土城区', '新庄区', '新店区', '中和区', '永和区', '树林区', '三峡区', '莺歌区', '三重区', '芦洲区', '五股区', '泰山区', '林口区', '八德区', '三峡区', '淡水区', '汐止区', '瑞芳区', '三重区', '土城区', '三峡区', '莺歌区', '树林区'],
    '桃园市': ['桃园区', '中坜区', '平镇区', '八德区', '杨梅区', '芦竹区', '大溪区', '龙潭区', '龟山区', '大园区', '观音区', '新屋区', '复兴区'],
    '台中市': ['中区', '东区', '南区', '西区', '北区', '北屯区', '西屯区', '南屯区', '太平区', '大里区', '雾峰区', '乌日区', '丰原区', '后里区', '潭子区', '大雅区', '沙鹿区', '清水区', '梧栖区', '大甲区', '外埔区', '大安区', '和平区'],
    '台南市': ['中西区', '东区', '南区', '北区', '安平区', '安南区', '永康区', '归仁区', '新化区', '左镇区', '玉井区', '楠西区', '南化区', '仁德区', '关庙区', '龙崎区', '官田区', '麻豆区', '佳里区', '西港区', '七股区', '将军区', '学甲区', '北门区', '后壁区', '白河区', '东山区', '柳营区', '盐水区', '善化区', '新市区', '山上区', '安定区'],
    '高雄市': ['楠梓区', '左营区', '鼓山区', '三民区', '新兴区', '前金区', '苓雅区', '盐埕区', '前镇区', '旗津区', '小港区', '凤山区', '林园区', '大寮区', '大树区', '大社区', '仁武区', '鸟松区', '冈山区', '桥头区', '燕巢区', '田寮区', '阿莲区', '路竹区', '湖内区', '茄萣区', '永安区', '弥陀区', '梓官区', '旗山区', '美浓区', '六龟区', '甲仙区', '杉林区', '内门区', '茂林区', '桃源区', '那玛夏区'],
    '基隆市': ['仁爱区', '信义区', '中正区', '中山区', '安乐区', '暖暖区', '七堵区'],
    '新竹市': ['东区', '北区', '香山区'],
    '嘉义市': ['东区', '西区']
  },
  '香港特别行政区': {
    '香港': ['中西区', '东区', '南区', '湾仔区', '九龙城区', '观塘区', '深水步区', '黄大仙区', '油尖旺区', '北区', '大埔区', '沙田区', '西贡区', '荃湾区', '屯门区', '元朗区', '葵青区', '离岛区']
  },
  '澳门特别行政区': {
...
function buildSearchIndex() {
  const index = [];
  for (const [province, cities] of Object.entries(administrativeDivisions)) {
    // 省级
    index.push({ level: 'province', name: province, fullName: province, children: Object.keys(cities) });
    for (const [city, districts] of Object.entries(cities)) {
      // 市级
      index.push({ level: 'city', name: city, fullName: `${province}-${city}`, parent: province, children: districts });
      // 区级
      for (const district of districts) {
        index.push({ level: 'district', name: district, fullName: `${province}-${city}-${district}`, parent: city, grandParent: province });
      }
    }
  }
  return index;
...
export function RegionInput({ label, value = [], onChange, placeholder = '输入地区名称搜索...' }) {
  ...
  const [selectedLevel, setSelectedLevel] = useState(null); // { type: 'province'|'city'|'district', value, fullName }
  ...
  const handleInputChange = (e) => {
    ...
    setInputValue(val);
    if (val.length >= 1) {
      const results = searchDivisions(val);
        ...
        <div className="absolute z-50 w-full mt-1 bg-white dark:bg-[#2a2a3c] border border-[#e5e4e7] dark:border-[#3a3a4c] rounded-lg shadow-lg max-h-60 overflow-y-auto">
          {suggestions.map((item, idx) => (
            ...
            >
              ...
              {item.level === 'district' && (
                <span className="text-xs text-[#6b6375]">{item.parent}</span>
              )}
            </button>
          ))}
        </div>
