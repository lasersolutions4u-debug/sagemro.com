...
export function AboutModal({ isOpen, onClose }) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="关于小智" size="sm">
      <div className="text-center py-4">
        ...
        <div className="text-left space-y-4 text-xs text-[#08060d] dark:text-[#e4e4e7] leading-relaxed">
          <p>
            小智是智维钣金平台的 AI 助手，服务于钣金加工行业的后服务市场。它面向的不是单一设备品类，而是钣金加工全链条——激光切割机、折弯机、焊接设备、自动化产线及其周边耗材与备件——为设备使用方和服务合伙人提供 7×24 小时的智能技术支持。
          </p>
          <p>
            小智的核心价值是让每一个设备用户都能在需要帮助的时刻，立刻获得专业、可靠的技术服务。无论是凌晨赶工时的一个报警代码，还是周末产线上的一次参数异常，用户不必再等待、不必再辗转——小智作为用户与合伙人之间的智能枢纽，确保问题在第一时间被专业地响应。
          </p>
          <p>
