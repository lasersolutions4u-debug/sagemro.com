...
const copy = {
  en: {
    ...
    intro: 'An AI-assisted independent service platform for laser cutting and sheet metal equipment. Explain the field situation once, and SAGEMRO helps turn it into a clear path for diagnosis, spare parts, consumables, maintenance, retrofit, automation accessories, laser peripherals, or press brake tooling.',
    howItWorks: 'How It Works',
    moments: [
      { icon: MessageCircle, title: 'Start With A Conversation', desc: 'Describe the alarm, part, cut quality issue, maintenance need, retrofit idea, or peripheral equipment request in plain language.' },
    ...
    standards: [
      ...
      'Parts, consumables, maintenance, peripherals, automation upgrades, and press brake tooling needs can grow naturally from the same service record',
    ],
    featureCards: [
    ...
    longTermText: 'Each conversation can become a reusable service record: faster future troubleshooting, clearer parts decisions, better maintenance planning, and more confident upgrade or accessory decisions.',
  ...
  zh: {
    ...
    intro: '面向激光切割与钣金加工设备的第三方智能服务平台。你只需说明现场情况，SAGEMRO 会帮助梳理问题、确认关键信息，并把它推进到诊断、备件、维保、服务协调或增购改造评估。',
    howItWorks: '如何工作',
    moments: [
      { icon: MessageCircle, title: '从一次对话开始', desc: '用自然语言描述报警、备件、切割质量、维保需求或增购改造需求，不需要先填复杂表单。' },
    ...
    standards: [
      ...
      '备件、维保、激光周边、自动化改造和折弯模具需求可以从同一服务记录自然延展',
    ],
    featureCards: [
    ...
    longTermText: '每一次对话都可以整理为可复用的服务记录：让后续排故更快、备件判断更清晰、维保计划更主动，增购改造决策也更有依据。',
