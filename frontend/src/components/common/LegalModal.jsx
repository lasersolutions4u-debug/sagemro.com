...
3.3 客户支付的总费用由维修服务费（代收后转付给工程师）和平台技术服务费（平台收取）两部分组成，在报价确认页面分别列明。
...
4.3 工程师的维修服务费由平台代收后转付。平台按工程师等级收取技术服务费：初级 20%、高级 15%、专家 12%。

## 五、费用结构与代收代付

5.1 本平台采用代收代付模式：客户支付的总费用中，维修服务费转付给工程师，平台技术服务费作为平台信息技术服务收入。

5.2 平台技术服务费在工程师提交报价、客户确认后自动计算，在工单完成结算时从代收款项中扣除。

5.3 发票说明：平台就技术服务费部分开具信息技术服务类发票，维修服务费部分的发票由工程师按其主体资质自行开具。

## 六、免责声明

6.1 AI 小智提供的技术咨询内容基于通用行业知识，仅供参考。我们不对 AI 咨询内容的准确性、完整性作任何保证。

6.2 本平台仅提供信息撮合及代收代付服务，不对工程师提供的维修服务质量、效果承担直接责任。维修服务的法律责任由工程师（维修服务提供方）承担。

6.3 AI 报价审核结论仅基于历史数据分析，不构成定价建议或价格承诺。

## 七、法律适用与争议解决

7.1 本协议适用中华人民共和国法律。

7.2 因本协议引起的争议，双方应友好协商解决；协商不成的，可向济南钰峭机械有限公司所在地有管辖权的人民法院提起诉讼。
