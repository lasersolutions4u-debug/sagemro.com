...
1.1 SAGEMRO Service OS 面向激光切割机与钣金加工设备，提供 AI 辅助咨询、服务申请整理、官方服务协调、设备档案、备件咨询、维保跟进和新机选型支持。

1.2 SAGEMRO 是官方服务流程，不是公开技师撮合平台。客户向 SAGEMRO 提交服务需求后，由 SAGEMRO 审核并在适用情况下安排内部工程师或 SAGEMRO 指定服务人员。
...
3.1 客户可通过 SAGEMRO AI 对话开始咨询，也可通过可用入口提交官方服务申请。
    ...
    <Modal isOpen={isOpen} onClose={onClose} title={titles[activeTab]} size="lg">
      ...
      <div className="max-h-[60vh] overflow-y-auto pr-1">
        <p className="text-[11px] text-[var(--color-text-muted)] mb-3">
          {isCn
            ? '生效日期：2026 年 6 月 7 日。平台运营方：Jinan Euchio Machinery Co., Ltd.'
