...
const LOGIN_COPY = {
  cn: {
    ...
    needServiceDesc: '告诉 SAGEMRO 你的设备情况，我们会帮助整理并推进后续服务确认。',
  ...
  en: {
    ...
    needServiceDesc: 'Tell SAGEMRO about your equipment. We will organize the case and guide the next service step.',
    ...
    customerDesc: 'Get AI diagnostics, service requests, equipment records, spare parts, and maintenance follow-up.',
