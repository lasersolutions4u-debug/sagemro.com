...
const COPY = {
  cn: {
    ...
    subtitle: '我们面向激光和成型设备工程师开放合作申请。申请通过后，工程师可根据服务区域、设备经验和可服务时间参与派工。',
    primary: '申请成为服务工程师',
    applyNow: '申请加入',
    howItWorks: '申请流程',
    ...
    pillars: [
      ...
      { title: '接单前查看工单资料', text: '工程师可提前查看客户描述、设备信息、已有记录和备件准备情况。' },
    ...
    faqs: [
      ...
      { q: '只招激光切割机工程师吗？', a: '不是。激光切割是主要品类，折弯机、CNC 等成型设备经验也同样欢迎。' },
  ...
  en: {
    ...
    title: 'Join the SAGEMRO Service Engineer Network',
    subtitle: 'We accept applications from engineers who service laser and metal forming equipment. Approved engineers may receive work based on service region, equipment experience, and availability.',
    ...
    whatTitle: 'How SAGEMRO service work is coordinated',
    whatText: 'SAGEMRO receives customer service requests, prepares the available job information, coordinates engineers, reviews quotes, confirms payment status, and keeps service records.',
    pillars: [
      ...
      { title: 'Job context before dispatch', text: 'Approved engineers receive customer descriptions, machine details, attachments, and available service records before work starts.' },
    ...
    valuesTitle: 'How engineer cooperation works',
    valuesText: 'Applying does not guarantee immediate work. Approved engineers may receive requests that match their region, equipment experience, and availability.',
    joinTitle: 'What you may receive after approval',
    joinIntro: 'Approved engineers may receive service requests that match their region, equipment experience, and availability. Each job follows the recorded scope, quote, payment status, and service report.',
    joinItems: [
      ...
      { title: 'Job information before dispatch', text: 'Before dispatch, you may receive customer descriptions, machine details, service history, attachments, and follow-up requirements.' },
    ...
    modalTitle: 'Apply as a Service Engineer',
    fields: {
      name: 'Name',
      phone: 'Phone',
      email: 'Email',
