...
const COPY = {
  en: {
    ...
    empty: 'No service assignments yet',
    emptyHint: 'New tasks will appear here when Admin matches a request to your region and skills. Make sure your status is set to Available.',
    loading: 'Loading...',
  },
  cn: {
    ...
    returnDispatch: '退回派工',
    empty: '暂无派工任务',
    emptyHint: '当 Admin 匹配到适合你区域和技能的任务时，会显示在这里。请确保你的服务状态设置为"可接单"。',
    loading: '加载中...',
  },
};
