// 中国行政区划数据（省-市-区三级）+ 搜索索引
//
// 公开 API：searchDivisions(query) → 返回最多 20 条匹配项
// 每条形如：{ level: 'province'|'city'|'district', name, fullName, parent?, grandParent?, children? }
...
// 公开搜索函数：按 query 子串模糊匹配，最多返回 20 条
