...
// Status CSS variable key maps to --status-{key} and --status-{key}-bg
export const statusConfig = {
  pending: { text: 'Pending', color: 'bg-blue-500', textColor: 'text-blue-500', cssVar: 'pending' },
  pending_dispatch: { text: 'Pending Regional Dispatch', color: 'bg-indigo-500', textColor: 'text-indigo-500', cssVar: 'pending_dispatch' },
  assigned: { text: 'Assigned', color: 'bg-yellow-500', textColor: 'text-yellow-500', cssVar: 'assigned' },
  in_progress: { text: 'In Progress', color: 'bg-orange-500', textColor: 'text-orange-500', cssVar: 'in_progress' },
  pricing: { text: 'Awaiting Quote', color: 'bg-purple-500', textColor: 'text-purple-500', cssVar: 'pricing' },
  pending_payment: { text: 'Awaiting Payment', color: 'bg-pink-500', textColor: 'text-pink-500', cssVar: 'pending_payment' },
  payment_review: { text: 'Payment Review', color: 'bg-amber-500', textColor: 'text-amber-500', cssVar: 'payment_review' },
  in_service: { text: 'In Service', color: 'bg-cyan-500', textColor: 'text-cyan-500', cssVar: 'in_service' },
  resolved: { text: 'Resolved', color: 'bg-green-500', textColor: 'text-green-500', cssVar: 'resolved' },
  pending_review: { text: 'Pending Review', color: 'bg-teal-500', textColor: 'text-teal-500', cssVar: 'pending_review' },
  completed: { text: 'Completed', color: 'bg-gray-500', textColor: 'text-gray-500', cssVar: 'completed' },
  rejected: { text: 'Rejected', color: 'bg-red-500', textColor: 'text-red-500', cssVar: 'rejected' },
  cancelled: { text: 'Cancelled', color: 'bg-gray-400', textColor: 'text-gray-400', cssVar: 'cancelled' },
};

export const statusConfigCn = {
  pending: { text: '待确认', color: 'bg-blue-500', textColor: 'text-blue-500', cssVar: 'pending' },
  pending_dispatch: { text: '待区域派工', color: 'bg-indigo-500', textColor: 'text-indigo-500', cssVar: 'pending_dispatch' },
  assigned: { text: '已派工', color: 'bg-yellow-500', textColor: 'text-yellow-500', cssVar: 'assigned' },
  in_progress: { text: '处理中', color: 'bg-orange-500', textColor: 'text-orange-500', cssVar: 'in_progress' },
  pricing: { text: '待报价', color: 'bg-purple-500', textColor: 'text-purple-500', cssVar: 'pricing' },
  pending_payment: { text: '待付款', color: 'bg-pink-500', textColor: 'text-pink-500', cssVar: 'pending_payment' },
  payment_review: { text: '付款审核中', color: 'bg-amber-500', textColor: 'text-amber-500', cssVar: 'payment_review' },
  in_service: { text: '服务中', color: 'bg-cyan-500', textColor: 'text-cyan-500', cssVar: 'in_service' },
  resolved: { text: '待客户确认', color: 'bg-green-500', textColor: 'text-green-500', cssVar: 'resolved' },
  pending_review: { text: '待评价', color: 'bg-teal-500', textColor: 'text-teal-500', cssVar: 'pending_review' },
  completed: { text: '已完成', color: 'bg-gray-500', textColor: 'text-gray-500', cssVar: 'completed' },
  rejected: { text: '已拒绝', color: 'bg-red-500', textColor: 'text-red-500', cssVar: 'rejected' },
  cancelled: { text: '已取消', color: 'bg-gray-400', textColor: 'text-gray-400', cssVar: 'cancelled' },
};
